...
from modules.dataBaseService.dal.wip_assy import WipAssyDAL
from modules.dataBaseService.models.wip_assy import WipAssy
...
class WipAssyBLL(BaseBLL[WipAssy]):
    ...
    def __init__(self):
        ...
        self.logger = Logger().get_logger('wipAssyBLL')
        # 创建实例级别的缓存
